...
import com.animesh.productstore.services.ProductsRepository;
import com.animesh.productstore.model.*;
...
public class ProductController {
	...
	@GetMapping({"","/"})//this method is accessible using url=localhost:8080 or localhost:8080/ 
	...
	@GetMapping("/avatar") //this method is accessible using url=localhost:8080/create
	public String showAvatarPage () {
		
		return "products/avatar";//in resources/templates the products folder is defined
	}
